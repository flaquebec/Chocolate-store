...
require 'header.php';?>
 ...
 <nav aria-label="breadcrumb">
  ...
  <!--Container de produtos e de novos produtos -->
  <div class="container mt-5">
    <nav class="navbar navbar-light justify-content-between">
      <a href="/admin/produto.php" class="btn simpleBtn" role="button">Novo</a>
              ...
              <tr>
                <td>
                  <a 
                    ...
                    href="/admin/produto.php?id=<?php echo $product['id'];?>">
                    Editar
                  </a>
                  <a 
                    class="btn btn-danger btn-sm" 
                    href="/admin/adminProdutos.php?id=<?php echo $product['id'];?>&action=delete"
                    onclick="return confirm('Deseja realmente remover o produto: <?php echo htmlentities($product['name']);?>?')">
                    Excluir
                  </a>
                </td>
